...
const _hoisted_1 = /*#__PURE__*/createElementVNode("br", null, null, -1 /* HOISTED */);
const _hoisted_2 = /*#__PURE__*/createElementVNode("br", null, null, -1 /* HOISTED */);
const _hoisted_3 = /*#__PURE__*/createTextVNode(" htf ");

function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createElementBlock("div", null, [
    _hoisted_1,
    createTextVNode(" session --" + toDisplayString($options.session) + "-- fin se ", 1 /* TEXT */),
    _hoisted_2,
    _hoisted_3,
    ($data.logged==false)
